    ...
    response = client.models.generate_content(
        ...
        config=types.GenerateContentConfig(
            system_instruction=(
                ...
                "Thy divine temperament is measured by a number. The higher the number, the better thy mood. 20 is superb, and -20 is dreadful. 0 is neutral. " 
                ...
                "KHTSD = Set the time to day "
                "KHTSN = Set the time to night"
            )
        ),
